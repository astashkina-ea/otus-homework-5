...
public class PersonalInfoForm extends AbsBaseComponent {
    ...
    public void fillPersonalInfo() {
        enterToTextArea(firstNameField, firstNameValue);
        enterToTextArea(lastNameField, lastNameValue);
        enterToTextArea(firstNameLatinField, firstNameLatinValue);
        enterToTextArea(lastNameLatinField, lastNameLatinValue);
        enterToTextArea(blogNameField, blogNameValue);
        enterToTextArea(dateOfBirthField, dateOfBirthValue);
        webDriverWait.waitForVisibleElement(сountryField);
        сountryField.click();
        webDriverWait.waitForVisibleElement(countrySelection);
        ...
        cityField.click();
        webDriverWait.waitForVisibleElement(citySelection);
        citySelection.click();
        languageField.click();
        ...
        webDriverWait.waitForVisibleElement(сommunicationSelectionOne);
        ...
        webDriverWait.waitForVisibleElement(сommunicationSelectionTwo);
        сommunicationSelectionTwo.click();
        contactTwoField.click();
        enterToTextArea(contactTwoField, contactTwoValue);
        gendersField.click();
